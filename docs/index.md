...
The bundled knowledge base covers model documentation, tutorials, API reference, workflow templates, community FAQ,
and the official scvi-tools Hugging Face Hub model registry.
