...
**Class:** `scviva.external.DIAGVI` (not yet in a published scviva-tools release — available on the `main` branch only as of 2026-07-28; this entry has narrative user-guide content only, no extracted signature/docstring, until it ships on PyPI)
